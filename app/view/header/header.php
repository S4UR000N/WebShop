...
<nav id="nav" class="navbar navbar-light pt-3 pb-3" style="background-color: #0099CC;">
    <div id="header" class="container-fluid justify-content-around">
        <span id="cart" class="headerItem borderRounded" data-toggle="modal" data-target="#cartModal" onclick="cart.displayCartProducts();"><i class="fas fa-shopping-cart text-danger">&thinsp;</i></span>
        ...
        <button id="pay" class="headerItem borderRounded text-danger" onclick="pay.payThePrice();"><b>PAY</b></button>
    </div>
</nav>
